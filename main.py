...
class User:
    ...
    def insert(Name, Email, Phone_num, Ticket,Status="Not solved"):
        try:
            ...
            ## Returning both the message and the ticket ID so frontend can display it
            return {"message": "Ticket raised successfully", "ticket_id": str(id), "department": department}
